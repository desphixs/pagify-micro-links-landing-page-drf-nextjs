...
import { Menu, LayoutDashboard, Settings, LogOut, ChevronLeft, Milestone, Users, User, X, Link2 } from "lucide-react";
...
export default function DashboardWrapper({ children }: DashboardWrapperProps) {
    ...
    const navItems = useMemo(
        () => [
            { label: "Links", href: "/dashboard/links", icon: <Link2 size={20} /> },
